...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://botmaker:<password>@cluster0.ep2fz9t.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'arey_mawa2')
